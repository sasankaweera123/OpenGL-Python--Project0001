...
def main():
    ...
    def window_resize(window, width, height):
        ...
        project = pyrr.matrix44.create_perspective_projection_matrix(45, width / height, 0.1, 100)
        glUniformMatrix4fv(proj_loc, 1, GL_FALSE, project)
    ...
    # load image
    image = Image.open("IMG/crate.jpg")
